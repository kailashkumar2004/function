...
// function num() {
//     var array = [12, 33, 45, 67, 89, 90, 100, 26, 31, 75];
//     var max = array[0]
//     var i = 0
//     while (i < array.length) {
//         if (array[i] > max) {
...
// function number() {
//     var array = [7, 8, 9, 5, 3, 23, 45, 67, 89, 21, 12, 26];
//     var min = array[0]
//     var i = 0
//     while (i < array.length) {
//         if (array[i] < min) {
...
// function number() {
//     var array = [12, 34, 56, 78, 90, 64, 10, 97, 42, 30];
//     var sum = 0
//     var i = 0
//     while (i < array.length) {
//         sum = sum + array[i]
...
//     function num() {
//         var array = [1, 2, 3, 45, 67, 89, 94, 2, 3, 1, 45, 67, 80, 53, 10, 39];
//         var uniqueNumber = []
//         for (var i = 0; i < array.length; i++) {
//             if (uniqueNumber.indexOf(array[i]) == -1) {
//                 uniqueNumber.push(array[i])
